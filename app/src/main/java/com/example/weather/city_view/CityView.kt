package com.example.weather.city_view
...
class CityView : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        cityFactory = LocationWeatherFactory(
            com.example.weather.data_source.location_weather_repo.LocationWeatherRepo.getInstance(
                com.example.weather.data_source.location_weather_repo.location_weather_remote.LocationWeatherApiClient.getInstance(),
        ...
        lifecycleScope.launch {
            cityViewModel.responseFlow.collect { result ->
                when (result) {
                    is com.example.weather.data_source.location_weather_repo.LocationWeatherApiState.Loading -> {
                        binding.loading.visibility = View.VISIBLE
                        binding.pageLayout.visibility = View.GONE
                    }
                    is com.example.weather.data_source.location_weather_repo.LocationWeatherApiState.Success -> {
