...
class DailyAdapter(val context: Context, var tempUnit: String) :
    ListAdapter<com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily, DailyAdapter.ViewHolder>(DailyAdapter.DailyDiffUtil()) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var currentDay: com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily = getItem(position)
...
//        }
    ...
    class DailyDiffUtil : DiffUtil.ItemCallback<com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily>() {
        override fun areItemsTheSame(oldItem: com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily, newItem: com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily): Boolean {
            return oldItem.dt == newItem.dt
        }

        override fun areContentsTheSame(oldItem: com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily, newItem: com.example.weather.data_source.location_weather_repo.location_weather_pojo.Daily): Boolean {
